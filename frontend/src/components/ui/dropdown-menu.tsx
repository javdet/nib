	...
	return (
		<DropdownMenuPrimitive.SubTrigger
			...
			className={cn(
				...
				'text-sm outline-none transition-colors duration-[var(--dur-fast)]',
				'focus:bg-foreground/[0.07] data-[state=open]:bg-foreground/[0.07]',
...
>(function DropdownMenuSubContent({ className, ...props }, ref) {
	return (
		<DropdownMenuPrimitive.SubContent
			ref={ref}
			className={cn(
				'glass-menu z-50 min-w-[8rem] overflow-hidden rounded-lg border p-1',
				'text-popover-foreground duration-[var(--dur-med)]',
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				...
				'duration-[var(--dur-fast)] focus:bg-foreground/[0.07]',
...
>(function DropdownMenuSeparator({ className, ...props }, ref) {
	return (
		<DropdownMenuPrimitive.Separator
			ref={ref}
			className={cn('hairline -mx-1 my-1 h-px', className)}
			{...props}
		/>
	)
})
